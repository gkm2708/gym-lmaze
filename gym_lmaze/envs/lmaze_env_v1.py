...
class LmazeEnv(gym.Env):
  ...
  def __init__(self):
    ...
    self.grid = np.array(  [['W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W', 'W'],
                                ['W', 'S', 'B', 'B', 'B', 'W', 'B', 'B', 'B', 'B', 'W', 'W'],
                                ['W', 'B', 'W', 'W', 'W', 'W', 'B', 'W', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'W', 'B', 'W', 'B', 'B', 'B', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'W', 'B', 'W', 'B', 'W', 'B', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'B', 'B', 'W', 'X', 'W', 'B', 'W', 'W', 'W', 'W'],
                                ['W', 'B', 'W', 'B', 'W', 'B', 'W', 'B', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'W', 'B', 'W', 'B', 'W', 'B', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'W', 'B', 'B', 'B', 'W', 'B', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'W', 'W', 'W', 'W', 'W', 'B', 'W', 'B', 'W', 'W'],
                                ['W', 'B', 'B', 'B', 'B', 'W', 'B', 'B', 'B', 'B', 'W', 'W'],
